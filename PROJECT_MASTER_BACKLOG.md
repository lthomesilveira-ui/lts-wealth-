...
- [ ] V183-F02: present every documented historical card family in Cartões/Faturas, including Bradesco Visa, Bradesco Visa Aeternum, Itaú Mastercard Black, Itaú Visa and C6, with correct bank/name, selected period and traceable coverage. “Visa Aeternum” is the exact canonical spelling.
  - Audit of the original historical workbook confirms an additional Bradesco card final absent from the eight-row runtime inventory; its product/band is not documented in the inspected fields. Do not map it to the user's R$ 29,90 Visa observation by amount alone. Recover its product evidence or show it explicitly as unidentified historical instrument without generating invoice/spend; reconcile all source finals with inventory and financial cycles. Details remain private.
