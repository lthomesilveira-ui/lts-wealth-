...
- [ ] Require branch CI Chromium/WebKit and candidate smoke before fixed homologation exposure; authenticated real-data/write and physical-iPhone evidence remain explicitly open.
