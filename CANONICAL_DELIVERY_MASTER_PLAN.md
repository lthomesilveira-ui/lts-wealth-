...
- [x] Fixed homologation manifest selects exact green canonical v1.12 product `70c49b1…` through exposure `adac528…`; public promotion remains separate and unauthorized.
