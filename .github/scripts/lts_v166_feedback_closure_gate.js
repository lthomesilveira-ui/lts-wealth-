...
for(const token of ['v165_preserved:true','flow_1409_preserved:true','decorateUpdates','decorateExpense','decorateDashboard','decorateWealth','openTransaction','openProposal','openAward','openCipo'])assert(js.includes(token),'runtime missing '+token);
