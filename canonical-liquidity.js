...
function ensureModules(){
  ...
  ]).then(()=>load('canonical-presentation-v157.js?v=20260908-session6','canonicalPresentationV157')).then(()=>load('canonical-capabilities-v161.js?v=20260908-dashboard-density15','canonicalCapabilitiesV161')).then(()=>load('canonical-reviewed-input-v112.js?v=20260908-dashboard-density15','canonicalReviewedInputV112')).then(()=>{mark({flow_loaded:true,product_loaded:true,presentation_loaded:true,polish_loaded:true,capabilities_loaded:true,reviewed_input_loaded:true});return true}).catch(e=>{modulesPromise=null;mark({error:String(e?.message||e)});throw e});
