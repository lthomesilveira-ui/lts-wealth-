...
function ensureModules(){
  ...
  modulesPromise=Promise.all([
    load('canonical-product-v157.js?v=20260907-v157plus-product-3','canonicalProductV157'),
    load('canonical-flow-v157.js?v=20260907-v157plus-product-3','canonicalFlowV157')
  ]).then(()=>load('canonical-presentation-v157.js?v=20260907-v157plus-product-3','canonicalPresentationV157')).then(()=>{mark({flow_loaded:true,product_loaded:true,presentation_loaded:true,polish_loaded:true});return true}).catch(e=>{modulesPromise=null;mark({error:String(e?.message||e)});throw e});
