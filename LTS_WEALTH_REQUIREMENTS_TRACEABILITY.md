...
| QA-01 | QA automática antes do usuário; zero regressão; distinguir teste automático de validação real. | Gates permanentes e checkpoints cobrem v1.6 Pass 6 em desktop Chromium e mobile WebKit. | Recovery/candidate `34185954453` / `34185954506`; canonical gate/candidate `34186087590` / `34186087628`; main smoke/Pages `34186301851` / `34186300869`; pós-exposição também verde. | Usuário não deve ser QA botão a botão; iPhone físico autenticado segue não alegado. | Expandir para recibo único da definição de pronto e manter claims honestos. |
