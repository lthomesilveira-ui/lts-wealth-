...
Última auditoria material: 10/09/2026 01:00 BRT (America/Sao_Paulo)
...
Estado desta definição: `IMPLEMENTADO_NAO_E2E_REAL`. A V1.24 fecha o pacote automático de legibilidade responsiva do Dashboard sobre toda a linha recuperada até V1.23, mas ainda não substitui comprovadamente o Excel no uso diário porque os lifecycles autenticados e o iPhone físico não foram executados juntos.
...
| Canonical v1.24 Responsive Dashboard Readability | Mantém a referência compacta 1312×1199 e cria composições legíveis explícitas para 1366×900, 1024×900 e 390×844 sob `executive-readable-breakpoints-v1`. | `VERDE_AUTOMATICO`; produto `39cb869f…` exposto por `084a3521…`; quatro perfis medidos, E2E real/físico aberto. |
...
| DASH-01 | Dashboard visualmente alinhado à referência oficial 1312×1199. | Pass 6 restaura hierarquia/conteúdo; V1.15 fecha o overflow; V1.16 adiciona a decisão V151; V1.19 fecha a revisão material; V1.24 preserva o canvas oficial e fecha a legibilidade nas três classes adicionais. | Gates V1.24 `34434661341` e `34435078818`, quatro artefatos de Dashboard e smokes pós-exposição verdes. | Referência `VALIDADO_USUARIO`; URL fixa V1.24 verificada no alvo exato. | `IMPLEMENTADO_NAO_E2E_REAL`: material visual automático fechado; falta dado real autenticado/iPhone. |
...
| REL-01 | Homologação fixa preservada; root público separado e protegido. | Manifesto exposto em `084a3521b0b42a2f15b8ec18348dc90f7bdc2d65` aponta ao produto V1.24 `39cb869f27f7a5eb7e5f6c57ed125f7b2d2aa4fc`; `index.html` intacto. | Gates pré/pós-exposição e Pages verdes; URL fixa resolveu o alvo exato e assets `20260910-dashboard24`; browser gate certifica zero iframe/fixture/raw error. | Homologação autorizada; promoção do root público não foi necessária e permanece separada. | Manter `not_promoted` até decisão explícita específica sobre o root. |
