...
Última auditoria material: 07/09/2026 23:35 BRT (America/Sao_Paulo)
...
| QA-01 | QA automática antes do usuário; zero regressão; distinguir teste automático de validação real. | Gates permanentes e checkpoints cobrem v1.6 em desktop Chromium e mobile WebKit. | Recovery/candidate `34179625830` / `34179625805`; canonical gate/candidate `34179823179` / `34179823167`; main smoke/Pages `34179954294` / `34179953893`; pós-exposição também verde. | Usuário não deve ser QA botão a botão; iPhone físico autenticado segue não alegado. | Expandir para recibo único da definição de pronto e manter claims honestos. |
...
| REL-01 | Homologação fixa preservada; root público separado e protegido. | Homologação aponta ao produto `501fb48265b02a5416f0fc198a54abf8688ddd14`; exposição `39689a3ba6648eeb633cddec8feee26b7d8f6766`; `index.html` intacto. | Smokes/Pages pré e pós-exposição verdes; URL fixa verificada no navegador. | Promoção não autorizada. | Continuar `not_promoted` até autorização explícita. |
