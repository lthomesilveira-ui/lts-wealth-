...
| V162 Daily Flow Recovery | Recupera diretamente o componente de Fluxo V150 preservado em `index.html`, usa V152 como referência, leitura atual V10 e não inclui Dashboard nesta homologação. | `RECUPERACAO_EM_CURSO`; cadeia cumulativa rejeitada pelo gate, montagem direta em validação e homologação humana ainda separada. |
...
| FLOW-01 | Fluxo passado/hoje/futuro, horizonte operacional de 90 dias, prioridade absoluta de confiabilidade. | Recuperação V162 restaura diretamente o contrato visual/funcional V150 preservado e usa `lts_browser_flow_v10`: 11 colunas operacionais, histórico contínuo, hoje, projeção e quatro contas. | Gate desktop/mobile V162 em execução; o run `34492222128` rejeitou a cadeia cumulativa por congelamento. | Usuário apontou V150/V152 como piso aceito e rejeitou a superfície posterior. | `RECUPERACAO_EM_CURSO`; E2E autenticado físico após gate determinístico. |
