...
- Current evidence metadata records a reduction of 275 shares after the prior snapshot and a user-confirmed sale, but exact trade settlement date/price/proceeds remain pending documentary reconciliation.
...
- Open Finance written pricing/support/SLA/product×bank coverage; no consent/spend/credential/provider commitment without explicit user decision.
