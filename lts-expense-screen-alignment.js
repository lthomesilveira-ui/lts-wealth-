...
(function () {
  ...
  function runtime() {
    ...
    ex135MonthDetail=function(s){
      ...
      const precision=d.legacy?.source_precision?.notice;
    ...
    despesas=function(){
      ...
      const precision=s.data.source_precision?.notice;
